...
**Фазы 0–5 — в `main`.** Фаза 0 (инфраструктура/каркас), Фаза 1 (данные+RBAC,
...
Опц. отложено — PR 9e «Останні отримувачі». Следующая — **Фаза 6** (поддержка/
дежурство + персонал/аналитика), ведёт alex.
