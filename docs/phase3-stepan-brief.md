> ⚠️ **Исторический артефакт.** Фаза 3 закрыта в июне 2026; документ описывает
> постановку на момент старта и не отражает текущий продукт. Оставлен как история
> процесса — не использовать как инструкцию. Актуальное — [ROADMAP.md](ROADMAP.md)
> и [PROGRESS.md](../PROGRESS.md).
